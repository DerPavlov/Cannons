...
public class InventoryManagement 
{
	...
	//####################################  removeAmmoFromChest ##############################
	public boolean removeAmmoFromChests(CannonData cannon, int gunpowder, Material projectile)
	{   
	...
	//####################################  removeAmmoFromChest ##############################
	private boolean removeAmmoFromChest(Block block1, Block block2, int gunpowder, Material projectile)
	{
	    ...
	    do
	    {
	    	notEnoughGunpowder = !removeItemInChests(invlist, Material.SULPHUR);
	    	removed_gunpowder++;
	    ...
	    {   
	    	//restore items
	    	addItemInChests(invlist,  Material.SULPHUR, removed_gunpowder);
	    	return false;
	    }
	...
	//####################################  removeAmmoFromChest ##############################
	private boolean removeItemInChests(ArrayList<Inventory> invlist, Material item)
	{
	...
	private boolean containsItemInChests(ArrayList<Inventory> invlist, Material item)
	{
		Iterator<Inventory> iter = invlist.iterator();
		while (iter.hasNext())
		{
	...
	//####################################  addItemInChests ##############################
	private boolean addItemInChests(ArrayList<Inventory> invlist, Material item, int amount)
	{
